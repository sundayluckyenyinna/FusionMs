...
@NoArgsConstructor
@AllArgsConstructor
public class LocalTransferWithInternalPayload {
    ...
    @Pattern(regexp = "^[0-9]{11}|(PL([5-6])([0-9]{4}))|(NGN1([0-9]{4})([0-9]{1})([0-9]{3})|NGN1([0-9]{4})([0-9]{1})([0-9]{3})([0]{2})([0-9]{2})|[0-9]{10})$", message = "Credit account must be either PL or NGN account number")
